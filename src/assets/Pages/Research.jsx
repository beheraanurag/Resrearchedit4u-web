    ...
    <div>
      ...
      <section className="text-center px-5 py-8">
        ...
        <div className="flex justify-center flex-wrap gap-6">
          <Card className="bg-white p-6 h-[300px] w-[300px] rounded-full border-2 border-black shadow-md transition-all hover:-translate-y-1 hover:scale-105 hover:shadow-lg hover:border-[#0a1a79] hover:bg-[#FFDCDC] cursor-pointer">
            <CardContent className="p-0 flex flex-col items-center justify-center h-full">
              <div className="text-8xl mb-4">🎓</div>
              <h3 className="text-lg text-gray-900 mb-3 font-bold">Early-stage PhD/MPhil/Master's scholars</h3>
              <p className="text-base text-gray-600 leading-6">Clarifying scope and feasibility</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white p-6 h-[300px] w-[300px] rounded-full border-2 border-black shadow-md transition-all hover:-translate-y-1 hover:scale-105 hover:shadow-lg hover:border-[#0a1a79] hover:bg-[#FFDCDC] cursor-pointer">
            <CardContent className="p-0 flex flex-col items-center justify-center h-full">
              <div className="text-8xl mb-4">📖</div>
              <h3 className="text-lg text-gray-900 mb-3 font-bold">Researchers Refining</h3>
              <p className="text-base text-gray-600 leading-6">Proposals after supervisor feedback or pilots</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white p-6 h-[300px] w-[300px] rounded-full border-2 border-black shadow-md transition-all hover:-translate-y-1 hover:scale-105 hover:shadow-lg hover:border-[#0a1a79] hover:bg-[#FFDCDC] cursor-pointer">
            <CardContent className="p-0 flex flex-col items-center justify-center h-full">
              <div className="text-8xl mb-4">📝</div>
              <h3 className="text-lg text-gray-900 mb-3 font-bold">Professionals Planning</h3>
              <p className="text-base text-gray-600 leading-6">Studies requiring ethics approval and realistic timelines</p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="text-center px-5 py-2.5 font-serif">
        ...
        <div className="flex justify-center gap-8 flex-wrap mb-8">
          <Card className="bg-[#eff2fb] p-5 w-[260px] rounded-xl shadow-md transition-all hover:-translate-y-1 hover:scale-105 hover:shadow-lg border-none">
            <CardContent className="p-0">
              <img src={AI} alt="AI + Plagiarism Report" className="w-20 h-20 mb-2.5 mx-auto" />
              <h3 className="text-lg text-black mb-2.5 font-bold">Tell Us Your Goal</h3>
              <p className="text-base text-gray-600 min-h-[40px] leading-[1.4]">Share your research stage, topic interests, and university requirements. This helps us align your plan with academic and practical expectations.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#eff2fb] p-5 w-[260px] rounded-xl shadow-md transition-all hover:-translate-y-1 hover:scale-105 hover:shadow-lg border-none">
            <CardContent className="p-0">
              ...
              <h3 className="text-lg text-black mb-2.5 font-bold">We Draft Your Plan</h3>
              <p className="text-base text-gray-600 min-h-[40px] leading-[1.4]">Our experts create your topic shortlist, map methods, and prepare a timeline that fits your deadlines.</p>
            </CardContent>
          </Card>

          <Card className="bg-[#eff2fb] p-5 w-[260px] rounded-xl shadow-md transition-all hover:-translate-y-1 hover:scale-105 hover:shadow-lg border-none">
            <CardContent className="p-0">
              <img src={PAY} alt="Rejection Risk Check" className="w-20 h-20 mb-2.5 mx-auto" />
              <h3 className="text-lg text-black mb-2.5 font-bold">Quotation & Payment</h3>
              <p className="text-base text-gray-600 min-h-[40px] leading-[1.4]">Detailed Quotation and Transparent Payment Terms for Seamless Project Execution and Client Satisfaction.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#eff2fb] p-5 w-[260px] rounded-xl shadow-md transition-all hover:-translate-y-1 hover:scale-105 hover:shadow-lg border-none">
            <CardContent className="p-0">
              ...
              <h3 className="text-lg text-black mb-2.5 font-bold">You Review & Refine</h3>
              <p className="text-base text-gray-600 min-h-[40px] leading-[1.4]">We carefully walk you through the draft, gather feedback, and fine-tune every section until it's ready.</p>
            </CardContent>
          </Card>

          <Card className="bg-[#eff2fb] p-5 w-[260px] rounded-xl shadow-md transition-all hover:-translate-y-1 hover:scale-105 hover:shadow-lg border-none">
            <CardContent className="p-0">
              <img src={FINAL} alt="Journal Match Pro" className="w-20 h-20 mb-2.5 mx-auto" />
              <h3 className="text-lg text-black mb-2.5 font-bold">Get Your Final Pack</h3>
              <p className="text-base text-gray-600 min-h-[40px] leading-[1.4]">Receive a submission-ready document (DOCX/PDF) with references, diagrams, timelines, and an ethics checklist.</p>
            </CardContent>
          </Card>
        </div>
        <div className="mb-5">
          ...
          >
            <Button variant="outline" className="bg-white text-[#0B2662] border-2 border-black px-5 py-2.5 rounded font-bold text-[15px] transition-all hover:bg-[#0B2662] hover:text-white">
      ...
      <section className="text-center px-5 py-12 bg-[#0B2662] rounded-2xl my-12 mx-auto max-w-[950px] shadow-lg">
        ...
        <div className="text-lg mb-6 leading-[1.3]">
          ...
          <br />
          <Link to="/publication" className="text-[#e0e7ff] no-underline font-medium transition-colors hover:text-[#facc15] hover:underline">Publication Support</Link>
          <br />

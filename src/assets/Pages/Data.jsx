...
const Data = () => {
  ...
  const whoThisIsFor = [
    { icon: "🌍", title: "Academic Expertise Globally", desc: "Statisticians and data scientists across India, UAE, UK, Australia." },
    { icon: "📈", title: "High Publication Success Rate", desc: "Research support aligned with top-tier journal standards." },
    { icon: "📝", title: "Ethical & University-Compliant", desc: "Strictly adhering to academic integrity and compliance." },
  ];

  const howItWorks = [
    { img: AI, title: "Data Submission", desc: "Upload data securely, ensure confidentiality, receive acknowledgment." },
    { img: Risk, title: "Project Scoping", desc: "Analyze requirements, define objectives, plan methodology, get transparent quotation & payment options." },
    ...
    { img: Journal, title: "Research Execution", desc: "Clean & preprocess data, perform advanced analysis, interpret results, share progress updates." },
    { img: FINAL, title: "Delivery & Ongoing Support", desc: "Deliver final report, ensure compliance, provide revisions, offer ongoing consultation." },
  ];
    ...
    <div>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-5 md:px-10 py-10 bg-[#0f0c29] gap-5">
        <div className="flex-1 max-w-[900px] px-5 md:px-10">
          <h2 className="text-2xl md:text-[2.4rem] font-bold text-white mb-5 font-serif text-center md:text-left">Expert Data Analysis Services for Researchers, PhD Scholars, and Academics.</h2>
          <p className="text-lg md:text-[1.4rem] text-white mb-6 font-medium leading-7 md:leading-[2.2rem] text-center md:text-left">
            Unlock the power of data-driven insights with professional support tailored to your research needs.
          </p>
          ...
          <ul className="list-none p-0 m-0 mb-9">
            <li className="flex items-center text-base md:text-[1.2rem] font-medium mb-3.5 text-gray-100">
              ...
              1000+ Researchers Supported Worldwide.
            </li>

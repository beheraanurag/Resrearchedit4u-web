...
const Academic = () => {
  ...
  const whoThisIsFor = [
    { icon: "🏆", title: "Thesis Defense Support", desc: "Guiding scholars for confident thesis defense and viva." },
    { icon: "✅", title: "Research Presentation Design", desc: "Designing impactful posters and presentations for researchers." },
    { icon: "📈", title: "Conference Style Guidance", desc: "Ensuring alignment with journal and conference style requirements." },
  ];

  const howItWorks = [
    { img: AI, title: "Consultation & Brief", desc: "Share your conference/venue, audience level, and goals (poster, oral presentation, or viva). We align on content scope and deliverables." },
    { img: Risk, title: "Content Structuring", desc: "We shape your talk/poster using research-friendly structure, selecting key messages, figures, and captions." },
    { img: PAY, title: "Transparent Quote & Payment", desc: "You receive a clear plan and pricing for the selected services. Work starts after payment confirmation." },
    { img: Journal, title: "Design & Visualization", desc: "We design for readability: concise text, large fonts, purposeful graphics, and minimal distractions—following proven university guidelines." },
    { img: FINAL, title: "Review & Refinement", desc: "Feedback cycles on content and visuals; final files exported to conference specs (size, resolution, aspect ratio, accessibility notes)." },
  ];
    ...
    <div>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-5 md:px-10 py-10 bg-[#0f0c29] gap-5">
        <div className="flex-1 max-w-[900px] px-5 md:px-10">
          <h2 className="text-2xl md:text-[2.4rem] font-bold text-white mb-5 font-serif text-center md:text-left">Present Your Research with Clarity & Impact</h2>
          <p className="text-lg md:text-[1.4rem] text-white mb-6 font-medium leading-7 md:leading-[2.2rem] text-center md:text-left">
            Expert support for academic presentations—from research posters and conference slides to thesis defense (viva) decks, data visualization, and presentation coaching.
          </p>
          ...
          <ul className="list-none p-0 m-0 mb-9">
            <li className="flex items-center text-base md:text-[1.2rem] font-medium mb-3.5 text-gray-100">
              ...
              University-style poster/layout guidance
            </li>

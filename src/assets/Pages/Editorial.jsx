...
const Editorial = () => {
  ...
  const whoThisIsFor = [
    { icon: "🏆", title: "Expert Academic Editors", desc: "PhD experts ensuring clarity, accuracy, and excellence." },
    { icon: "✅", title: "Journal-Ready Formatting", desc: "APA, MLA, IEEE, or custom styles as per submission requirements." },
    { icon: "📈", title: "Secure & Trusted Process", desc: "Ethical editing with strict confidentiality and NDA-backed safeguards." },
  ];

  const howItWorks = [
    { img: AI, title: "Upload Manuscript", desc: "Share your draft and style guide with experts for accurate, polished, publication-ready work." },
    { img: Risk, title: "Expert Editing", desc: "Substantive, language, formatting edits ensure clarity, precision, and compliance with academic journal standards." },
    { img: PAY, title: "Quotation & Payment", desc: "Detailed Quotation and Transparent Payment Terms for Seamless Project Execution and Client Satisfaction." },
    { img: Journal, title: "Plagiarism Check", desc: "Optional Turnitin-style report available to check originality, ensuring plagiarism-free, ethical academic submissions." },
    { img: FINAL, title: "Final Delivery", desc: "We deliver a polished, submission-ready manuscript tailored to journal guidelines and reviewer expectations." },
  ];
    ...
    <div>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-5 md:px-10 py-10 bg-[#0f0c29] gap-5">
        <div className="flex-1 max-w-[900px] px-5 md:px-10">
          <h2 className="text-2xl md:text-[2.4rem] font-bold text-white mb-5 font-serif text-center md:text-left">Expert Editorial Support for Research and Publication Success.</h2>
          <p className="text-lg md:text-[1.4rem] text-white mb-6 font-medium leading-7 md:leading-[2.2rem] text-center md:text-left">
            Expert Editorial Support for Research & Publication Success, Ensuring Clarity, Accuracy, and Impact.
          </p>
          ...
          <ul className="list-none p-0 m-0 mb-9">
            ...
            <li className="flex items-center text-[1.2rem] font-medium mb-3.5 text-gray-100">
              <FaCheck className="text-[#f0a70a] mr-2.5 text-lg" />
              Format to APA / IEEE / MLA / journal
            </li>
            <li className="flex items-center text-[1.2rem] font-medium mb-3.5 text-gray-100">
              <FaCheck className="text-[#f0a70a] mr-2.5 text-lg" />
              Eliminate plagiarism & humanize AI text
            </li>
          </ul>
